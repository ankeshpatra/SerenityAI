...
const DoctorConsultation: React.FC = () => {
  ...
  return (
    <div className="py-20 px-4 bg-stress-dark">
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl">
                <div className="bg-white/5 p-6 rounded-xl border border-white/10 backdrop-blur-lg">
                  <h3 className="text-cyan-400 text-xl font-semibold mb-2">Instant Consultation</h3>
                  <p className="text-white/80">Connect with doctors within 60 seconds</p>
                </div>
                <div className="bg-white/5 p-6 rounded-xl border border-white/10 backdrop-blur-lg">
                  <h3 className="text-cyan-400 text-xl font-semibold mb-2">Verified Doctors</h3>
                  <p className="text-white/80">Consult with experienced and verified medical professionals</p>
                </div>
                <div className="bg-white/5 p-6 rounded-xl border border-white/10 backdrop-blur-lg">
                  <h3 className="text-cyan-400 text-xl font-semibold mb-2">24/7 Availability</h3>
                  <p className="text-white/80">Access healthcare support anytime, anywhere</p>
                </div>
              </div>
              <button
                onClick={handlePractoNavigation}
                className="mt-8 bg-cyan-400 text-black px-8 py-4 rounded-full font-semibold text-lg hover:bg-cyan-300 transform hover:scale-105 transition-all duration-300 flex items-center space-x-2"
              >
