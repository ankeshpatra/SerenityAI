  ...
  return (
    <div className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-stress-dark via-stress-gray to-stress-dark animate-gradient">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(79,195,247,0.08)_0%,transparent_50%)] animate-pulse"></div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Chat with Amy */}
          <div className="rounded-2xl border border-cyan-400/20 p-6 flex flex-col h-full bg-white/5 backdrop-blur-md shadow-lg hover:shadow-cyan-400/20 hover:shadow-xl transition-all duration-300 hover:bg-white/10 hover:border-cyan-400/40 group">
            <div className="flex items-center space-x-4 mb-4">
              <MessageCircle className="w-6 h-6 text-stress-yellow" />
              <h3 className="text-xl font-semibold text-white">Chat with Amy</h3>
            </div>
            <p className="text-gray-300 flex-grow">
              Experience 24/7 mental health support through our advanced AI companion.
            </p>
            <button 
              onClick={() => navigate('/chat-with-serenity')}
              className="w-full px-6 py-3 rounded-full bg-stress-yellow text-stress-dark font-medium hover:bg-cyan-300 transition-colors duration-300 mt-auto flex items-center justify-center gap-2"
            >
              Learn More
